...
# Sidebar navigation with radio buttons including Home Page
app_selection = st.sidebar.radio(
    "Choose an App",
    ["🏠 Home", "💬 Invoice Chatbot", "📄 Invoice Data Extractor"]
)
...
if app_selection == "🏠 Home":
    home_page()
elif app_selection == "💬 Invoice Chatbot":
    invoice_chatbot()
elif app_selection == "📄 Invoice Data Extractor":
